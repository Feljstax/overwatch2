...
""" urlpatterns = [
 ...
 """
urlpatterns = [
    #path('', heroes_views.index, name='home'),
    path('', heroes_views.index.as_view(), name='home'),
    path('api/heroes/', heroes_views.hero_list),
    path('api/heroes/<int:pk>/', heroes_views.hero_detail)
] + static(settings.STATIC_URL, document_root=settings.STATIC_ROOT)